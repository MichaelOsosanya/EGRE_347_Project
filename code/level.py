...
class Level:
    ...
    def projectile_projectile_collide(self):
         for projectile1 in self.projectiles.sprites():    
            for projectile2 in self.projectiles.sprites():     #made two instances of the projectile, one for player and one for enemy
                if projectile1 != projectile2:                  #if they are not equal..
                    if pygame.sprite.collide_rect(projectile1, projectile2):  #..and they collide
